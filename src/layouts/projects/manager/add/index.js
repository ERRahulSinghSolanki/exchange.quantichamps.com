...
const AddManager = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      await fetchWithAuth(`${API_URL}/manager`, {
        method: "POST",
  ...
  // ✅ Use backend-provided label and value directly
    ...
    <DashboardLayout>
      ...
      <SoftBox p={3}>
        ...
        <SoftBox component="form" onSubmit={handleSubmit} autoComplete="off">
          ...
          <SoftBox mb={2}>
            ...
            <select
              ...
              style={{
                ...
                border: "1px solid #d2d6da", fontSize: "14px",
          ...
          {/* Shifts */}
          <SoftBox mb={2}>
            <SoftTypography variant="caption" fontWeight="bold">Shifts</SoftTypography>
            <Select
              isMulti
              name="shift_ids"
              options={shiftOptions}
              value={shiftOptions.filter(option => formData.shift_ids.includes(option.value))}
              onChange={handleShiftChange}
              isDisabled={!formData.branch_id || loading.shifts}
              placeholder="Select Shifts"
              styles={{
                control: (provided) => ({ ...provided, border: "1px solid #d2d6da", borderRadius: "6px", fontSize: "14px" }),
                placeholder: (provided) => ({ ...provided, fontSize: "14px", color: "#999" }),
          ...
          <SoftBox mb={2}>
            ...
            <SoftInput value="Manager" readOnly fullWidth style={{ backgroundColor: "#f0f0f0", cursor: "not-allowed" }} />
          </SoftBox>
          ...
          <SoftBox mt={4} display="flex" justifyContent="flex-end" gap={2}>
            ...
            <SoftButton variant="gradient" color="dark" type="submit" disabled={loading.form}>
              {loading.form ? "Adding..." : "Add Manager"}
            </SoftButton>
          </SoftBox>
        </SoftBox>
      </SoftBox>
