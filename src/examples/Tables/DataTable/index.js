    ...
    <TableContainer sx={{ boxShadow: "none" }}>
      {entriesPerPage || canSearch ? (
        <SoftBox display="flex" justifyContent="space-between" alignItems="center" p={1}>
          {entriesPerPage && isShowEntriesPageContent && (
            <SoftBox display="flex" alignItems="center">
              <SoftSelect
                ...
                size="small"
              />
            <SoftTypography variant="caption" sx={{ fontSize: "12px"}} color="secondary">
                &nbsp;&nbsp;entries per page
              </SoftTypography>
...
DataTable.propTypes = {
  ...
  isShowEntriesPageContent: PropTypes.bool
};
